...
if ( get_theme_mod( 'namaha-header-image-text-overlay-text-shadow', customizer_library_get_default( 'namaha-header-image-text-overlay-text-shadow' ) ) ) {
...
$header_image_text = pll__( get_theme_mod( 'namaha-header-image-text', customizer_library_get_default( 'namaha-header-image-text' ) ) );
