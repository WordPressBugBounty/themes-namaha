...
function namaha_customizer_library_options() {
    ...
    $panels[] = array(
	    ...
	    // Plugins - Sub-section
	    $section = 'namaha-styling-plugins';
	    
	    $sections[] = array(
    		'id' => $section,
    		'title' => __( 'Plugins', 'namaha' ),
    		'panel' => $panel,
    		'description' => __( 'Namaha adds custom styling to support external plugins:', 'namaha' )
	    );
	    
	    $options['namaha-bbpress-use-theme-styles'] = array(
    		'id' => 'namaha-bbpress-use-theme-styles',
    		'label'   => __( 'BBPress', 'namaha' ),
    		'section' => $section,
    		'type'    => 'checkbox',
    		'default' => 1,
    		'description' => ''
	    ...
	    $options['namaha-bookingpress-use-theme-styles'] = array(
    		'id' => 'namaha-bookingpress-use-theme-styles',
    		'label'   => __( 'BookingPress', 'namaha' ),
    		'section' => $section,
    		'type'    => 'checkbox',
    		'default' => 1,
    		'description' => ''
